...
private extern class Vector3Class
{
	 ...
	 */
	@:native("Angle")
	function angle(other:Vector3, axis:Vector3):Float;
	 ...
	 */
	@:native("FuzzyEq")
	function fuzzyEq(other:Vector3, epsilon:Float):Bool;
